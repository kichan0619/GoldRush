...
A low-poly kart racer generated end-to-end from a single prompt —
`a small low-poly kart racer with 3 laps and a lap timer` — with no manual coding.

![A kart racer generated by GoldRush Studio](docs/demo-game.gif)

![Still frame of the generated game](docs/demo-game-still.png)

The agent planned it, wrote the Babylon.js + TypeScript scene, built it, ran it in
a headless browser, and captured the screenshot and video above automatically.
